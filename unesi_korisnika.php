    ...
    <div class="container">
		...
		<?php
			...
			$ulica=$_POST['ulica'];
				...
				$upit="INSERT INTO korisnik(korisnickoIme, lozinka, ime, prezime, tel, email, grad, ulica, status)VALUES('$korisnik', '$passw', '$ime', '$prezime', '$telef', '$email', '$grad', '$ulica', '0')";
